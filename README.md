...
The goal of the ArtStudioManager project is to build management software for art studios.
It will provide functionality for the day-to-day tasks that must be completed, prioritizing:
